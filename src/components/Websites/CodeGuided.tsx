		...
		<Website
			...
			technologies={{
				icons: [
					...
					/>,
					<SiRedux
						className="hover:fill-[#774bdb]"
						data-tooltip-id="codeguided-redux"
					...
					/>,
					<SiStorybook
						className="hover:fill-[#ff5bbb]"
						data-tooltip-id="codeguided-storybook"
					...
					<SiGreensock
						...
						data-tooltip-id="codeguided-greensock"
						data-tooltip-content="GSAP"
					/>,
					<SiFirebase
						className="hover:fill-[#ff833b]"
						data-tooltip-id="codeguided-firebase"
					...
					/>,
					<SiNodedotjs
						className="hover:fill-[#16610f]"
						data-tooltip-id="codeguided-nodejs"
						data-tooltip-content="Node.js"
					/>,
					<SiJest
						className="hover:fill-[#411a3a]"
						data-tooltip-id="codeguided-jest"
						data-tooltip-content="Jest"
					/>,
					<SiPlaywright
						className="hover:fill-[#25b119]"
						data-tooltip-id="codeguided-playwright"
						data-tooltip-content="Playwright"
					/>,
					<SiTypeform
						className="hover:fill-[#704718]"
						data-tooltip-id="codeguided-typeform"
						data-tooltip-content="Typeform"
					/>,
					<SiEslint
						className="hover:fill-[#422fee]"
						data-tooltip-id="codeguided-eslint"
